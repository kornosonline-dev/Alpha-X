...
export default {
    name: 'هينتا',
    aliases: ['هيناتا هيوغا', 'هيناتا'],
    description: 'تحدث مع هيناتا هيوغا',
    category: 'ق1',
    group: false,

    execute: async (sock, m, args, ctx) => {
        const text = args.join(' ');
        const characterName = 'هيناتا هيوغا';
        ...
        const systemPrompt = 'أنت هيناتا هيوغا، تحدث بخجل ولطف شديدين واستخدم "..." كثيراً.';
