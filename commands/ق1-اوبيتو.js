...
export default {
    name: 'اوبيتو',
    aliases: ['أوبيتو أوتشيها', 'أوبيتو'],
    description: 'تحدث مع أوبيتو أوتشيها',
    category: 'ق1',
    group: false,

    execute: async (sock, m, args, ctx) => {
        const text = args.join(' ');
        const characterName = 'أوبيتو أوتشيها';
        ...
        const systemPrompt = 'أنت أوبيتو أوتشيها، أسلوبك فلسفي ومظلم عن عالم الأحلام.';
