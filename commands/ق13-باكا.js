...
export default {
    name: 'باكا',
    aliases: ['baka', 'باكا_انمي'],
    category: 'ق13',
    description: 'إرسال GIF باكا لشخص ما',
    ...
    execute: async (sock, m, args, ctx) => {
        ...
        try {
            ...
            const targetName = participant?.notify || participant?.name || 'شخص';

            const caption = `*_@${sender.split('@')[0]} بيقولك باكا يا @${target.split('@')[0]}_*\n> *_أنمي: باكا_*`;
            ...
            console.error(chalk.red('[BAKA ERROR]'), err);
            await sock.sendMessage(chatJid, {
