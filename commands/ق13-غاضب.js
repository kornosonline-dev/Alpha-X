...
export default {
    name: 'غاضب',
    aliases: ['angry', 'غضبان', 'غضب'],
    category: 'ق13',
    description: 'إرسال GIF غضب لشخص ما',
    ...
    execute: async (sock, m, args, ctx) => {
        ...
        try {
            ...
            const caption = `*_@${sender.split('@')[0]} غاضب على @${target.split('@')[0]}_*\n> *_أنمي: angry_*`;
            ...
            console.error(chalk.red('[ANGRY ERROR]'), err);
            await sock.sendMessage(chatJid, {
