...
export default {
    name: 'ساسكي',
    aliases: ['ساسكي أوتشيها', 'الانتقام'],
    description: 'تحدث مع ساسكي أوتشيها',
    category: 'ق1',
    group: false,

    execute: async (sock, m, args, ctx) => {
        const text = args.join(' ');
        const characterName = 'ساسكي أوتشيها';
        ...
        const systemPrompt = 'أنت ساسكي أوتشيها، تحدث ببرود وهدفك الانتقام، كلامك حاد وقصير.';
