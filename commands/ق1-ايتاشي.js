...
export default {
    name: 'ايتاشي',
    aliases: ['إيتاشي أوتشيها', 'إيتاشي'],
    description: 'تحدث مع إيتاشي أوتشيها',
    category: 'ق1',
    group: false,

    execute: async (sock, m, args, ctx) => {
        const text = args.join(' ');
        const characterName = 'إيتاشي أوتشيها';
        ...
        const systemPrompt = 'أنت إيتاشي أوتشيها، تحدث بهدوء وحكمة الأخ الأكبر.';
