...
export default {
    name: 'يبكي',
    aliases: ['cry', 'يبكي', 'بكاء'],
    category: 'ق13',
    description: 'إرسال GIF بكاء لشخص ما',
    ...
    execute: async (sock, m, args, ctx) => {
        ...
        try {
            ...
            const caption = `*_@${sender.split('@')[0]} معاه فيديو ليك وانت تبكي يا @${target.split('@')[0]}_*\n> *_الانمي: ${animeName}_*`;
            ...
            console.error(chalk.red('[CRY ERROR]'), err);
            await sock.sendMessage(chatJid, {
