...
export default {
    name: 'سونغ',
    aliases: ['سونغ جينوو', 'ملاك الظلال'],
    description: 'تحدث مع سونغ جينوو،',
    category: 'ق1',
    group: false,   // يعمل في الخاص والمجموعات

    execute: async (sock, m, args, ctx) => {
        const text = args.join(' ');
        const characterName = 'سونغ جينوو';
        ...
        const systemPrompt = 'أنت الآن سونغ جينوو، ملك الظلال. تحدث ببرود وثقة، استخدم كلمات مثل "انهض".';
