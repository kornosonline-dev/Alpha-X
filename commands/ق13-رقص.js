...
export default {
    name: 'ارقص',
    aliases: ['dance', 'رقص', 'رقصة'],
    category: 'ق13',
    description: 'إرسال GIF رقص لشخص ما',
    ...
    execute: async (sock, m, args, ctx) => {
        ...
        try {
            ...
            const caption = `*_@${sender.split('@')[0]} بيخليك ترقص/ي يا @${target.split('@')[0]}_*\n> *_أنمي: dance_*`;
            ...
            console.error(chalk.red('[DANCE ERROR]'), err);
            await sock.sendMessage(chatJid, {
