...
export default {
    name: 'ضحك',
    aliases: ['laugh', 'ههه', 'يضحك'],
    category: 'ق13',
    description: 'إرسال GIF ضحك لشخص ما',
    ...
    execute: async (sock, m, args, ctx) => {
        ...
        try {
            ...
            const caption = `*_@${sender.split('@')[0]} بيضحك عليك يا @${target.split('@')[0]}_*\n> *_أنمي: laugh_*`;
            ...
            console.error(chalk.red('[LAUGH ERROR]'), err);
            await sock.sendMessage(chatJid, {
